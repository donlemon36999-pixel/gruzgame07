...
/**
 * @title GruzGame07Onchain
 * @notice Tap + check-in game for Base. Deploy on Remix (Base Mainnet).
 *         Builder Code attribution is appended in the frontend tx calldata (env suffix), not in this contract.
 */
contract GruzGame07Onchain {
